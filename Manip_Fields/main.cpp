...
int main() {
    ...
    // Set field width to 10 for all three outputs
    ...
    // Set field width to 10 for all three outputs and justify all left
    std::cout << "\n----------------------Width 10 and left for all-------------------------" << std::endl;
    ruler();
    std::cout << std::setw(10) << std::left << num1
              << std::setw(10) << std::left << num2
              << std::setw(10) << std::left << hello << std::endl;

    // setfill to a dash. This is persistent. Then repeat the previous display
    std::cout << "\n---------------Width 10, left, and setfill dash for all------------------" << std::endl;
    ...
    std::cout << "\n-------------------Width 10, left, and setfill varies---------------------" << std::endl;
    ruler();
