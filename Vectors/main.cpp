...
//    vector <char> vowels (5); // 5 Initialised to 0.
...
//    cin >> score_to_add;
    ...
    cout << "Enter one more score to add to the vector: ";
...
//    cout << "This should cause an exception!!" << test_scores.at(10) << endl;
    ...
    cout << "\nMovie rating for reviewer #1 uisng array syntax:" << endl;
    cout << movie_ratings[0][0] << endl;
    cout << movie_ratings[0][1] << endl;
    cout << movie_ratings[0][2] << endl;
    cout << movie_ratings[0][3] << endl;

    cout << "\nMovie rating for reviewer #1 uisng vector syntax:" << endl;
